        ...
        if (shift < ngx_slab_exact_shift) {
            ...
            do {
                ...
                for (n = 0; n < map; n++) {
                    ...
                    if (bitmap[n] != (unsigned int)NGX_SLAB_BUSY) {
            ...
            do {
                if (page->slab != (unsigned int )NGX_SLAB_BUSY) {
            ...
            n = 1 << n;
            n = ((uintptr_t) 1 << n) - 1;
            mask = n << (unsigned int)NGX_SLAB_MAP_SHIFT;

            do {
                if ((page->slab & NGX_SLAB_MAP_MASK) != mask) {

                    for (m = (uintptr_t) 1 << (unsigned int)NGX_SLAB_MAP_SHIFT, i = 0;
                         m & mask;
                         m <<= 1, i++)
                    {
                        if ((page->slab & m)) {
