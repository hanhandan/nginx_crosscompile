...
ngx_atoi(u_char *line, size_t n)
{
    ...
    cutoff = (int)NGX_MAX_INT_T_VALUE / 10;
    cutlim = (int)NGX_MAX_INT_T_VALUE % 10;
...
ngx_atosz(u_char *line, size_t n)
{
    ...
    cutoff = (int)NGX_MAX_SIZE_T_VALUE / 10;
    cutlim = (int)NGX_MAX_SIZE_T_VALUE % 10;
...
ngx_atoof(u_char *line, size_t n)
{
    ...
    cutoff = (int)NGX_MAX_OFF_T_VALUE / 10;
    cutlim = (int)NGX_MAX_OFF_T_VALUE % 10;
...
ngx_atotm(u_char *line, size_t n)
{
    ...
    cutoff = (int)NGX_MAX_TIME_T_VALUE / 10;
    cutlim = (int)NGX_MAX_TIME_T_VALUE % 10;
...
ngx_hextoi(u_char *line, size_t n)
{
    ...
    cutoff = (int)NGX_MAX_INT_T_VALUE / 16;
